/**
 * CCIP token transfer (Example06-Step2). Same schema as example01.
 *
 * Command to run:
 *   npx hardhat example06-step2 --network <NETWORK_NAME> --source-router <SOURCE_ROUTER> --destination-chain-selector <DESTINATION_CHAIN_SELECTOR> --receiver <RECEIVER> --token-to-send <TOKEN_ADDRESS> --amount <AMOUNT> [--gas-limit 200000] [--block-confirmations 0] [--fee-token-address <FEE_TOKEN_ADDRESS>]
 */
...
export interface Example06Step2TaskArguments {
  sourceRouter: string;
...
export default async function example06Step2Action(
  taskArguments: Example06Step2TaskArguments,
  ...
  console.log("[INFO] CCT sender: ExtraArgsV3 token transfer (default finality)");
  ...
  console.log("[WARN] blockConfirmations = 0 means default finality.");
