/**
 * Example08-Step2: CCIP token transfer (same schema as Example06-Step2).
 *
 * Command to run:
 *   npx hardhat example08-step2 --network <NETWORK_NAME> --source-router <SOURCE_ROUTER> --destination-chain-selector <DESTINATION_CHAIN_SELECTOR> --receiver <RECEIVER> --token-to-send <TOKEN_ADDRESS> --amount <AMOUNT> [--gas-limit 200000] [--block-confirmations 0] [--fee-token-address <FEE_TOKEN_ADDRESS>]
 */
...
export interface Example08Step2TaskArguments {
  sourceRouter: string;
...
export default async function example08Step2Action(
  taskArguments: Example08Step2TaskArguments,
