...
import { getPrivateKey, getProviderRpcUrl, getRouterConfig, getPayFeesIn } from "../helpers/utils"
...
task(
  ...
  .setAction(async (taskArguments: TaskArguments) => {
    const { sourceBlockchain, basicTokenSenderAddress, destinationBlockchain, receiver, tokenAmounts, payFeesIn } =
      taskArguments
