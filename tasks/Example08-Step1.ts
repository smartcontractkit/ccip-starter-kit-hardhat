/**
 * Example08 (CCT 03): Configure BurnMint pool remote lane (same schema as Example06-Step1).
 *
 * Command to run:
 *   npx hardhat example08-step1 --network <NETWORK_NAME> --local-pool <LOCAL_POOL> --remote-chain-selector <REMOTE_CHAIN_SELECTOR> --remote-token <REMOTE_TOKEN> --remote-pool <REMOTE_POOL>
 */

import type { HardhatRuntimeEnvironment } from "hardhat/types/hre";
import { decodeAbiParameters, encodeAbiParameters } from "viem";

export interface Example08Step1TaskArguments {
  localPool: string;
...
export default async function example08Step1Action(
  taskArguments: Example08Step1TaskArguments,
  ...
  console.log("[INFO] Example08 (CCT 03): Configure BurnMint pool remote lane");
