import { CCIP_BnM_ADDRESSES, CCIP_LnM_ADDRESSES, LINK_ADDRESSES, PayFeesIn, routerConfig } from "./constants"
...
export const getProviderRpcUrl = (network: string) => {
  ...
  if (!rpcUrl) throw new Error(`rpcUrl empty for network ${network} - check your environment variables`)
