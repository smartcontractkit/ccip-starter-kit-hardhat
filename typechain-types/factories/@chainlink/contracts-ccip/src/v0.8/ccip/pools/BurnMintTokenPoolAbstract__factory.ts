...
import type {
  ...
  BurnMintTokenPoolAbstractInterface,
} from "../../../../../../../@chainlink/contracts-ccip/src/v0.8/ccip/pools/BurnMintTokenPoolAbstract";
...
export class BurnMintTokenPoolAbstract__factory {
  static readonly abi = _abi;
  static createInterface(): BurnMintTokenPoolAbstractInterface {
    return new Interface(_abi) as BurnMintTokenPoolAbstractInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      runner
    ) as unknown as BurnMintTokenPoolAbstract;
  }
}
