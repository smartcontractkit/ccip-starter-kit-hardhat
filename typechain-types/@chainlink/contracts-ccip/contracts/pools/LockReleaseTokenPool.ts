...
export interface LockReleaseTokenPoolInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "addRemotePool"
  ...
  encodeFunctionData(
    functionFragment: "getRebalancer",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "transferLiquidity",
...
export namespace LiquidityTransferredEvent {
...
export namespace RebalancerSetEvent {
  export type InputTuple = [
    oldRebalancer: AddressLike,
    newRebalancer: AddressLike
  ];
  export type OutputTuple = [oldRebalancer: string, newRebalancer: string];
  export interface OutputObject {
    oldRebalancer: string;
...
export interface LockReleaseTokenPool extends BaseContract {
  connect(runner?: ContractRunner | null): LockReleaseTokenPool;
  waitForDeployment(): Promise<this>;

  interface: LockReleaseTokenPoolInterface;
  ...
  getRebalancer: TypedContractMethod<[], [string], "view">;
  ...
  setRebalancer: TypedContractMethod<
  ...
  transferLiquidity: TypedContractMethod<
  ...
  getFunction(
    nameOrSignature: "setRebalancer"
  ): TypedContractMethod<[rebalancer: AddressLike], [void], "nonpayable">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "transferLiquidity"
  ): TypedContractMethod<
    [from: AddressLike, amount: BigNumberish],
    [void],
    "nonpayable"
  ...
  >;
  getEvent(
    key: "LiquidityTransferred"
  ): TypedContractEvent<
    LiquidityTransferredEvent.InputTuple,
    LiquidityTransferredEvent.OutputTuple,
    LiquidityTransferredEvent.OutputObject
  >;
  getEvent(
    key: "LockedOrBurned"
  ): TypedContractEvent<
  ...
  getEvent(
    ...
    RebalancerSetEvent.InputTuple,
    RebalancerSetEvent.OutputTuple,
    RebalancerSetEvent.OutputObject
  >;
  getEvent(
  ...
  filters: {
    ...
    "LiquidityTransferred(address,uint256)": TypedContractEvent<
      LiquidityTransferredEvent.InputTuple,
      LiquidityTransferredEvent.OutputTuple,
      LiquidityTransferredEvent.OutputObject
    >;
    LiquidityTransferred: TypedContractEvent<
      LiquidityTransferredEvent.InputTuple,
      LiquidityTransferredEvent.OutputTuple,
      LiquidityTransferredEvent.OutputObject
    >;
    ...
    "RebalancerSet(address,address)": TypedContractEvent<
      RebalancerSetEvent.InputTuple,
      RebalancerSetEvent.OutputTuple,
      RebalancerSetEvent.OutputObject
    >;
    RebalancerSet: TypedContractEvent<
      RebalancerSetEvent.InputTuple,
      RebalancerSetEvent.OutputTuple,
      RebalancerSetEvent.OutputObject
    >;
