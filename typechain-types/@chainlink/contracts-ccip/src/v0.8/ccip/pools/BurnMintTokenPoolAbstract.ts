...
export interface BurnMintTokenPoolAbstractInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "acceptOwnership"
      | "addRemotePool"
...
export interface BurnMintTokenPoolAbstract extends BaseContract {
  connect(runner?: ContractRunner | null): BurnMintTokenPoolAbstract;
  waitForDeployment(): Promise<this>;

  interface: BurnMintTokenPoolAbstractInterface;
